...
public class Exercise004Test {
    ...
    @Test
    public void checkGetDateSpecified() {

        Exercise004 ex004 = new Exercise004(LocalDate.of(2021, Month.JANUARY, 24));
        LocalDateTime expected = LocalDateTime.of(2052, Month.OCTOBER, 02, 1, 46, 40);
