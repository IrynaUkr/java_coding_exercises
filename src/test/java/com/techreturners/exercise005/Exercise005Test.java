...
public class Exercise005Test {
    ...
    @Test
    void checkThrowExceptionIfSentenceHasNonASCII() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> ex005.isPangram("¤EÀsÆW°ê»Ú®i¶T¤¤¤ß3¼Ó®i¶TÆU2~~KITEC 3/F Rotunda 2" ));
        String expected = "Input contains non ASCII symbol";
        assertEquals(expected, exception.getMessage());
    }
    @Test
    void checkThrowExceptionIfSentenceIsNull() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> ex005.isPangram( null ));
